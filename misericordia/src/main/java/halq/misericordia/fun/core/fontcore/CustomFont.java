package halq.misericordia.fun.core.fontcore;
...
public class CustomFont extends CFont {
    ...
    public float drawString(String textIn, double xI, double yI, int color, boolean shadow) {
        double x = xI;
        double y = yI;
        /*if (ModuleManager.INSTANCE.getModule(CustomFont.class).isEnabled() && !ModuleManager.INSTANCE.getModule(CustomFont.class).shadow.getValue() && shadow) {
            x -= 0.5;
            y -= 0.5;
        }*/
        x -= 1.0;
    ...
    public float drawString(String textIn, double xI, double yI, int color, boolean shadow, float fontSize) {
        double x = xI;
        double y = yI;
