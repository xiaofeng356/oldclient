...
public class ComponentItemMod extends ComponentItem {
    ...
    public ComponentItemMod(Module mod1, String displayText, String description1, int flags, int state, ComponentItemListener listener, float width1, float height1) {
