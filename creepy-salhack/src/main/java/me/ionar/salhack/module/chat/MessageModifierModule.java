...
public class MessageModifierModule extends Module {
    ...
    {
        if (event.Message.startsWith("/") || event.Message.startsWith("*") || event.Message.startsWith("-") || event.Message.startsWith("#") || event.Message.startsWith("$") || event.Message.startsWith("^") || event.Message.startsWith(";") || event.Message.startsWith(".") || event.Message.startsWith("&") || event.Message.startsWith(",") || event.Message.startsWith("!"))
            return;
        ...
        if (FancyChat.getValue()) {
            switch (FancyChatMode.getValue()) {
                case Circle:
                    message = convertToUCircle(message.toLowerCase());
                    break;
                case UwU:
                    //Thanks to Osiris for this UwU bit.
                    message = message.replace("l", "w").replace("ll", "ww").replace("r", "w").replace("R", "W") + " UwU";
        ...
        if (ColorChat.getValue() && Suffix.getValue() && Wheelchair.getValue() && TM.getValue())
            total_Message = getChatColor() + "\u267F" + message + "\u2122" + getSeparatorMode() + convertToUnicode(suffix);
            ...
            total_Message = "\u267F" + message + "\u2122" + getSeparatorMode() + convertToUnicode(suffix);
            ...
            total_Message = getChatColor() + "\u267F" + message + "\u2122";
