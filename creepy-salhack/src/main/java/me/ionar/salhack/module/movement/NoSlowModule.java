...
public final class NoSlowModule extends Module {
    ...
    @EventHandler
    private final Listener<EventPlayerUpdateMoveState> OnIsKeyPressed = new Listener<>(event ->
    {
    ...
    @EventHandler
    private final Listener<EventNetworkPostPacketEvent> PacketEvent = new Listener<>(event ->
    {
