...
public class OldAutoCrystalRewrite extends Module {
    ...
    private final List<BlockPos> _placeLocations = new CopyOnWriteArrayList<>();
    ...
    public OldAutoCrystalRewrite() {
        super("OldAutoCrystalRewrite", new String[]{"AutoCrystal3"}, "Salhack's 2.04.3 AutoCrystalRewrite.", "NONE", -1, Module.ModuleType.COMBAT);
    }
