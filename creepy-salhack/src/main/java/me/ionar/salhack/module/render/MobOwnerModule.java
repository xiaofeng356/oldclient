...
public class MobOwnerModule extends Module {
    ...
    private final List<AbstractHorse> mobs = new ArrayList<AbstractHorse>();
    private final Map<String, String> uuidToName = new HashMap<String, String>();
    ...
    public void onEnable() {
        ...
        for (Entity entity : mc.world.loadedEntityList) {
            ...
            AbstractHorse horse;
            if (!(entity instanceof AbstractHorse) || mobs.contains(horse = (AbstractHorse) entity))
                continue;
            mobs.add(horse);
