...
public abstract class AbstractGui {
    ...
    protected void fillGradient(int x1, int y0, int x0, int y1, int color0, int color1) {
        ...
        bufferbuilder.pos(x0, y0, this.blitOffset).color(r0, g0, b0, a0).endVertex();
        bufferbuilder.pos(x1, y0, this.blitOffset).color(r0, g0, b0, a0).endVertex();
        bufferbuilder.pos(x1, y1, this.blitOffset).color(r1, g1, b1, a1).endVertex();
        bufferbuilder.pos(x0, y1, this.blitOffset).color(r1, g1, b1, a1).endVertex();
        tessellator.draw();
