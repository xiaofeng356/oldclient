...
import ru.pablusha.AllahRecode.CommandMgr;
import ru.pablusha.AllahRecode.ModuleSys.Module;
import ru.pablusha.AllahRecode.Modules.Movement.NoSlowdown;
import ru.pablusha.AllahRecode.Modules.Player.Portals;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
    	CommandMgr cMgr = new CommandMgr();
    	if (message.startsWith("#")) {
    		cMgr.onCommand(message);
    		return;
    	}
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.inPortal)
        {
            if (this.mc.currentScreen != null && !this.mc.currentScreen.doesGuiPauseGame() && !Portals.mod.enabled)
            {
        ...
        if (this.isHandActive() && !this.isRiding() && !NoSlowdown.mod.enabled)
        {
