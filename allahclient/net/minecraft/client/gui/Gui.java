...
public class Gui
{
    ...
    public static void drawRect(float x, float y, float g, float h, int color)
    {
        ...
        bufferbuilder.pos((double)x, (double)h, 0.0D).endVertex();
        bufferbuilder.pos((double)g, (double)h, 0.0D).endVertex();
        bufferbuilder.pos((double)g, (double)y, 0.0D).endVertex();
     ...
     */
    public static void drawScaledCustomSizeModalRect(float g, float h, float u, float v, int uWidth, int vHeight, int width, int height, float tileWidth, float tileHeight)
    {
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.pos((double)g, (double)(h + height), 0.0D).tex((double)(u * f), (double)((v + (float)vHeight) * f1)).endVertex();
        bufferbuilder.pos((double)(g + width), (double)(h + height), 0.0D).tex((double)((u + (float)uWidth) * f), (double)((v + (float)vHeight) * f1)).endVertex();
        bufferbuilder.pos((double)(g + width), (double)h, 0.0D).tex((double)((u + (float)uWidth) * f), (double)(v * f1)).endVertex();
