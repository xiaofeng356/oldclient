...
import ru.pablusha.AllahRecode.Modules.Render.NoPotionRender;
import ru.pablusha.AllahRecode.Modules.Render.NoScoreBoard;
...
public class GuiIngame extends Gui
{
    ...
    protected void renderPotionEffects(ScaledResolution resolution)
    {
        ...
        if (!collection.isEmpty() && !NoPotionRender.mod.enabled)
        {
