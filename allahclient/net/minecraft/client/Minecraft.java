...
import ru.pablusha.AllahRecode.AllahMenu;
import ru.pablusha.AllahRecode.Modules.Combat.Criticals;
import ru.pablusha.AllahRecode.Modules.Misc.CustomMenu;
import ru.pablusha.AllahRecode.Modules.Player.FastPlace;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    {
        theMinecraft = this;
        AllahClient client = new AllahClient();
        client.start(this);
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        FontUtils.bootstrap();
		AllahClient.loader.sortModulesByWidth();
		AllahClient.fileMgr.init();
        ...
        {
        	if (!CustomMenu.mod.enabled) {
                this.displayGuiScreen(new GuiConnecting(new GuiMainMenu(), this, this.serverName, this.serverPort));
        	} else {
                this.displayGuiScreen(new GuiConnecting(new AllahMenu(), this, this.serverName, this.serverPort));
        	}
        }
        else
        {
        	if (!CustomMenu.mod.enabled) {
        		...
        		this.displayGuiScreen(new AllahMenu());
        	}
        }
