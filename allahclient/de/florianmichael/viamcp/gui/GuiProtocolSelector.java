...
public class GuiProtocolSelector extends GuiScreen {
    ...
    class SlotList extends GuiSlot {
		...
		@Override
		protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_,
				int p_192637_5_, int p_192637_6_, float p_192637_7_) {
			drawCenteredString(mc.fontRendererObj,(ViaLoadingBase.PROTOCOLS.indexOf(ViaLoadingBase.getInstance().getTargetVersion()) == p_192637_2_ ? ChatFormatting.GREEN.toString() + ChatFormatting.BOLD : ChatFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(p_192637_2_).getName(), width / 2, p_192637_3_ + 2, -1);
            GlStateManager.pushMatrix();
            GlStateManager.scale(0.5, 0.5, 0.5);
            drawCenteredString(mc.fontRendererObj, "PVN: " + ViaLoadingBase.getProtocols().get(p_192637_2_).getVersion(), width, (p_192637_3_ + 2) * 2 + 20, -1);
            GlStateManager.popMatrix();
		}
    }
}
